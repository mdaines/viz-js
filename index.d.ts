...
declare namespace VizJs {
    ...
    interface Viz {
        ...
        svgXmlToPngImageElement(svgXml: string, scale: number | undefined, callback: ImageCallback<HTMLImageElement>): void;
        svgXmlToPngImageElement(svgXml: string, scale?: number): HTMLImageElement;
        svgXmlToPngBase64(svgXml: string, scale: number | undefined, callback: ImageCallback<string>): void;
    }

    type ImageCallback<TData> = (error: Error | null, image: TData) => void;
